...
**這張圖需要 Grafana 帳號**（它是這裡唯一會驗證身分的服務）。還沒有帳號、
或要轉寄給沒有帳號的人：看下一節那一頁靜態報告，同一份判定、同樣三個字，不需要登入。
帳號從哪裡來寫在 [`platform/observability/README.md`](../platform/observability/README.md)。
